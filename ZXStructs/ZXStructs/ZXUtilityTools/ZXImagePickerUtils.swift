...
/// HImagePickerUtils
class ZXImagePickerUtils: NSObject,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    
    private var pickPhotoEnd: takeEndAction?
    
    func takePhoto(rootVC:UIViewController,completion:takeEndAction?) {
        pickPhotoEnd = completion
    ...
    func choosePhoto(rootVC:UIViewController,completion:takeEndAction?){
        pickPhotoEnd = completion
